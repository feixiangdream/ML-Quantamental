...
if __name__ == "__main__":
    ...
    riskfree, timeseries, factor = datatransfrom(path)[0], datatransfrom(path)[1], datatransfrom(path)[2]

    timeseries2, index = datatransfrom2(path)[0], datatransfrom2(path)[1]
